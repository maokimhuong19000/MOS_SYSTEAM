...
<div class="col-xs-12 Section" id="source-html" >
  <div class="blank_top"  >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
    ...
    <div class="col-md-12 body"  >                          
      ...
      <div class="blank_top"  >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
      <div class="col-md-12" align="center"  style="font-family: Khmer OS Muol Light ; font-size: 22px" >
      ...
      <div id="" class="mtable">                              
       ...
       @foreach($isubdetail->Materialrequestdetails as $quo) 
          <tr>
            <td style="" class="text-center"​>{{$i}}</td>
            <td style="" >{{$quo->Material->com_name}}</td>
            <td style="" class="text-right"​>{{number_format($quo->quantity,2)}} kg<br>
              <span style="font-size: 8pt">({{$quo->store_type}} kg = {{$quo->number}} cyl) </span>
            </td>
            <td style="" class="text-center"​>{{$quo->Material->substance}}</td>
            <td style="" class="text-center"​>{{$quo->Material->taxcode}}</td>
            <td style="" class="text-center"​>{{$quo->Material->un3}}</td>
            <td style="" align="center">{{$quo->quality}}</td>
          </tr>                                  
        ...
        @endforeach
          <tr>
            ...
            <td style="" align="center"><label>សរុប</label></td>
            <td style="" align="center">{{ number_format($total,2) }} kg</td>            
            <td style="" align="center"></td>
            <td style="" align="center"></td>
            <td style="" align="center"></td>
            <td style="" align="center"></td>
      ...
      <div class="blank_top"  >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>  
      <div class="col-md-12" >លិខិតអនុញ្ញាតនេះមានសុពលភាពសម្រាប់ការស្នើសុំនាំចូល មកពីប្រទេស {{\App\Helpers\AppHelper::instance()->get_khmer_only(@$isubdetail->mcountry->countries_name)}}&nbsp; តាមច្រក {{@$isubdetail->Port_Entries->port_name}}​។</div>
      <div class="blank_top"  >&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
