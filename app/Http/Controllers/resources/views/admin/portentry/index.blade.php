  	...
  	<div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h4 class="card-title">{{ trans('បញ្ចីឈ្មោះច្រកនាំចូល') }} </h4>
...
<script type="text/javascript">
    $(document).ready(function()
    {
            ...
            columns: [
              ...
              "render": function ( data, type, full, meta ) { 
                  ...
                  var status = '<span class="togglebutton"><label><input class="chkb" att-data="'+full.id+'" type="checkbox" '+ (full.status == 1 ? 'checked' : '') +'><span class="toggle"></span></label></span>' ;
                    ...
                    '{!! route('entry.edit','@id') !!}' + '"><i class="material-icons">edit</i><div class="ripple-container"></div></a></span>' ;
        ...
        $('body').on('change', '.chkb', function() {
          ...
          var url = "";
          if ($(this).is(':checked')) {
               url = '{!! route('entry.enable','@id') !!}' ;
          }else{
              url = '{!! route('entry.disable','@id') !!}' ;
          }
