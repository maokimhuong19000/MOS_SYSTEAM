...
<div class="col-lg-12 col-md-12">
  ...
  <div class="col-xs-12 " style="width: 100%" id="pdf_license">
  <div class="Section" style="  font-size:12pt; font-family: Khmer OS Siemreap, Roboto;">



  <div class="section-letterhead" class="row">
    ...
    <div class="col-md-4 header-text">
        <div class="text-center"  ><h3>ព្រះរាជាណាចក្រកម្ពុជា</h3></div>
         <div class="text-center"  ><h3>ជាតិ សាសនា ព្រះមហាក្សត្រ</h3></div>
    </div>

    <div class="col-md-4 empty-text"></div>
  
  </div>

  <div class="section-header" class="row" style="font-size:11pt">
    <div class="col-md-6 text-left">លេខ:{{$isubdetail->licence_no}}</div>
    <div class="col-md-6 text-right" >
        <div>ថ្ងៃ​​&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ខែ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ឆ្នាំ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ព.ស.&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
        <div>ធ្វើនៅរាជធានីភ្នំពេញ ថ្ងៃទី &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ខែ &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ឆ្នាំ&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
      </div>
  </div>
  <div class="col-md-12 text-center"    style="font-family: Khmer OS Muol Light ; font-size: 13pt" >
