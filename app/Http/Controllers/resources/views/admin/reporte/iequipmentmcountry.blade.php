...
@section('content')	
{{ Breadcrumbs::render('reporte_mcountry') }}
      ...
      var data, tableName= '#table_icountry',     str, strf
                ...
                tbl = $(tableName).dataTable({
                     proccessing:true,
                      ...
                      ajax:'{!! route('report.getiequipmentBymCountry.year')!!}?year='+yearr,
                       "columns" :  [                     
      ...
      $(tableName).DataTable().destroy();
              ...
              tbl =  $(tableName).dataTable({
                     ...
                     scrollX : true,
                      ...
                      ajax:'{!! route('report.getiequipmentBymCountry.filter')!!}?from='+froms+'&to='+tos,
                       "columns" :  [                     
                        { data: 'countries_name', name: 'countries_name' ,"visible": false },
...
$("#searchsub").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getiequipmentBymCountry.year')!!}?year='+yearr);
...
$("#searchf").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getiequipmentBymCountry.filter')!!}?from='+froms+'&to='+tos);
   total_year.api().column(0).search( opt ).draw();
  $.LoadingOverlay("hide");
});
