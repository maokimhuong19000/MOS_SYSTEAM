...
@section('content')	
{{ Breadcrumbs::render('report_xcountry') }}
<div class="row">
...
<div class="card-icon">
      ...
      <h4 class="card-title">{{trans('report_isubstance.icountry_title')}}</h4>
</div>
...
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 ">
<div class="card">
 <table id="table_icountry" class="table table-striped" cellspacing="0" width="100%" data-page-length='100'  ></table>
</div>
      ...
      jqxhr = $.ajax({ url: '{!! route('report.isubtancebycompany.column')!!}'+querystring ,  
              ...
              .done(function (data) {
                ...
                $(tableName).empty();
                 ...
                 $('<thead><tr><th>Country Export</th>').appendTo(tableName);
                ...
                tbl = $(tableName).dataTable({
                     proccessing:true,
                      ...
                      ajax:'{!! route('report.getIsubstanceByCountry.year')!!}?year='+yearr,
                      "columns" : colss,
      ...
      jqxhr = $.ajax({ url: '{!! route('report.isubtancebycompany.column')!!}'+querystring ,
              ...
              tbl =  $(tableName).dataTable({
                     ...
                     scrollX : true,
                      ...
                      ajax:'{!! route('report.getIsubstanceByCountry.filter')!!}?from='+froms+'&to='+tos,
                      "columns" : colss,
...
$("#searchsub").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getIsubstanceByCountry.year')!!}?year='+yearr);
...
$("#searchf").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getIsubstanceByCountry.filter')!!}?from='+froms+'&to='+tos);
   total_year.api().column(0).search( opt ).draw();
  $.LoadingOverlay("hide");
});
