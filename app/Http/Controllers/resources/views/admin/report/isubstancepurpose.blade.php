...
@section('content')	
{{ Breadcrumbs::render('report_purpose') }}
    ...
    var querystring =  "?year="+yearr ;
      ...
      jqxhr = $.ajax({ url: '{!! route('report.isubtancebycompany.column')!!}'+querystring ,  
              ...
              .done(function (data) {
                ...
                $(tableName).empty();
                   var jsoncolumn = {};
                    jsoncolumn["data"] = 'purpose';
                    jsoncolumn["name"] = 'purpose';   
                 ...
                 $('<thead><tr><th>Purpose</th>').appendTo(tableName);
                ...
                tbl = $(tableName).dataTable({
                     proccessing:true,
                      ...
                      ajax:'{!! route('report.getIsubstanceByPurpose.year')!!}?year='+yearr,
                      "columns" : colss,
      ...
      jqxhr = $.ajax({ url: '{!! route('report.isubtancebycompany.column')!!}'+querystring ,
              ...
              tbl =  $(tableName).dataTable({
                     ...
                     scrollX : true,
                      ...
                      ajax:'{!! route('report.getIsubstanceByPurpose.filter')!!}?from='+froms+'&to='+tos,
                      "columns" : colss,
...
$("#searchsub").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getIsubstanceByPurpose.year')!!}?year='+yearr);
...
$("#searchf").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getIsubstanceByPurpose.filter')!!}?from='+froms+'&to='+tos);
   total_year.api().column(0).search( opt ).draw();
  $.LoadingOverlay("hide");
});
