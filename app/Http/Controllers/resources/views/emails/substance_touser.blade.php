            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title" style="font-family: Battambang,Arial,Helvetica,sans-serif">{{$title_kh}}</td>
                    </tr>
                  </table>
                    ...
                    <tr>
                      ...
                      <td class="">
                         <table  class="body-text">
                           <tr>
                              <td class="bodycopy body-text-cell" align="left"><b>{{trans('label_contact.com_name')
                              }}:</b></td>
                            ...
                            <tr>
                             ...
                             <tr>
                                  ...
                                  <td align="" class="bodycopy  body-text-cell">{{$customer->created_at}}</td>
                              </tr>

                              <tr>
                                   <td class="bodycopy body-text-cell" align="left"><b>{{trans('idata.isubstance_no')}} :</b> </td>
                                  <td align="" class="bodycopy  body-text-cell">{{$request->request_no}}</td>
                             </tr>
                             <tr>
                        ...
                        <table class="body-text">                             
                                ...
                                @foreach($request->materialrequestdetails as $rd)
                                <tr>
                                  ...
                                  <tr>
                                      <td class="body-signature-cell">
                                          ...
                                          <div>
                                              ...
                                              <a href="{{route('materialrequest.materialrequest_detail',$request->id)}}"
