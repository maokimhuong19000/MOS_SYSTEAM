...
<div align="center">
    <table class="head-wrap w320 full-width-gmail-android" bgcolor="#f9f8f8" cellpadding="0" align="center" cellspacing="0"
           border="0">
        <tr>
                    ...
                    <table cellspacing="0">
                        <tr>
                            <td>
                                <table class="soapbox">
                                    <tr>
                                        <td class="soapbox-title" style="font-family: Battambang,Arial,Helvetica,sans-serif">គណនីថ្មីទើបបង្កើត រង់ចាំកាអនុញ្ញាតិ/New User Sign up. Waiting For Account Approval </td>
                                    </tr>
                                </table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <table  class="body-text">
                                                ...
                                                <tr>
                                                    <td class="bodycopy body-text-cell"  align="left"><b>{!!trans('label_contact.certificate_add_tax')!!}:</b></td>
                                                ...
                                                <tr>
                                                    <td class="body-signature-cell">
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="{{route('register.detail',$customer->id)}}"
