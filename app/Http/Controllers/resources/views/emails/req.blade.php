            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title" style="font-family: Battambang,Arial,Helvetica,sans-serif">{{trans('front_isubstance.material_request_detail')}} </td>
                    </tr>
                  </table>
                  ...
                  <table class="body">
                    <tr>
                      ...
                      <td class="">
                         <table  class="body-text">
                           <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                  <td class="bodycopy body-text-cell" align="left"><b>{{trans('back.request_date')
                                  }}:</b></td>
                                  <td align="" class="bodycopy  body-text-cell">{{$requestdetail->created_at}}</td>
                              </tr>

                              <tr>
                                   <td class="bodycopy body-text-cell" align="left"><b>{{trans('idata.isubstance_no')}} :</b> </td>
                        ...
                        <table class="body-text">                             
                                <tr>                                   
                                    <th class="" width="40%">{{trans('isubstance.type')}}</th>
                                    <th class="" width="30%">{{trans('isubstance.putting')}}</th>
                                     <th class="" width="30%">{{trans('isubstance.amount')}}</th>
                                    <th class=""  width="30%">{{trans('isubstance.quantity')}}</th>
                                ...
                                @foreach($requestdetail->materialrequestdetails as $rd)
                                <tr>
                                  ...
                                  <td style="padding-top:5px;" >
                                  {{number_format((float)$rd->quantity, 2, '.', '')}}
                                  </td>
                                </tr>
                                @endforeach
