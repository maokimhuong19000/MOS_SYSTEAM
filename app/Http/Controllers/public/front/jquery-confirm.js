...
(function ($) {
    ...
    Jconfirm.prototype = {
        ...
        _buildHTML: function () {
            ...
            this.$btnc = this.$el.find('.jconfirm-button');
    ...
    jconfirm.pluginDefaults = {
        ...
        '<div style="margin-top:0 !important" class="jconfirm-box" role="dialog" aria-labelledby="labelled" tabindex="-1">' +
        ...
        '</div>' +
        '<div><center class="jconfirm-button">' +
        '</center></div>' +
