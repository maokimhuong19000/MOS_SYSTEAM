...
@section('content')	
{{ Breadcrumbs::render('reporte_xcountry') }}
      ...
      var data, tableName= '#table_icountry',     str, strf
                ...
                tbl = $(tableName).dataTable({
                     proccessing:true,
                      ...
                      ajax:'{!! route('report.getiequipmentByCountry.year')!!}?year='+yearr,
                      "columns" :  [                     
                        { data: 'countries_name', name: 'countries_name' ,"visible": false },
      ...
      var data, tableName= '#table_icountry',     str, strf
              ...
              tbl =  $(tableName).dataTable({
                     ...
                     scrollX : true,
                      ...
                      ajax:'{!! route('report.getiequipmentByCountry.filter')!!}?from='+froms+'&to='+tos,
                      "columns" :  [                     
                        { data: 'countries_name', name: 'countries_name' ,"visible": false },
...
$("#searchsub").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getiequipmentByCountry.year')!!}?year='+yearr);
...
$("#searchf").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getiequipmentByCountry.filter')!!}?from='+froms+'&to='+tos);
   total_year.api().column(0).search( opt ).draw();
  $.LoadingOverlay("hide");
});
