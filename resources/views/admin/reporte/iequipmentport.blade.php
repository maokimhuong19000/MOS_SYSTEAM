...
@section('content')	
{{ Breadcrumbs::render('reporte_port') }}
    ...
    $(tableName).DataTable().destroy(); 
                ...
                tbl = $(tableName).dataTable({
                     proccessing:true,
                      ...
                      ajax:'{!! route('report.getiequipmentByPort.year')!!}?year='+yearr,
                      "columns" : [                     
                        { data: 'port_name', name: 'port_name' ,"visible": false },
      ...
      $(tableName).DataTable().destroy();
              ...
              tbl =  $(tableName).dataTable({
                     ...
                     scrollX : true,
                      ...
                      ajax:'{!! route('report.getiequipmentByPort.filter')!!}?from='+froms+'&to='+tos,
                     "columns" : [                     
                        { data: 'port_name', name: 'port_name' ,"visible": false },
...
$("#searchsub").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getiequipmentByPort.year')!!}?year='+yearr);
...
$("#searchf").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getiequipmentByPort.filter')!!}?from='+froms+'&to='+tos);
   total_year.api().column(0).search( opt ).draw();
  $.LoadingOverlay("hide");
});
