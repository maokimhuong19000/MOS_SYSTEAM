...
@section('content')
         ...
         {{ Breadcrumbs::render('create') }}
          ...
          <form action="{{route('register.store')}}" method="post" id="frm_create_user">
              ...
              <div class="col-lg-12 col-md-12">
                ...
                <div class="card">
                  <div class="card-header card-header-danger card-header-icon">
                    ...
                    <h4 class="card-title">{{trans('labelaccount.createuser')}}</h4>
                  </div>
                  <div class="card-body ">
                    ...
                    <div class="flash-message">
                      ...
                      <div class="form-group {{ $errors->has('idcard') ? 'has-danger' : ''}}">
                        ...
                        <input type="text" class="form-control" name="idcard" id="company_code">
                        ...
                        <option value="0">{{trans('importall.createuser')}}</option>
                        <option value="1">{{trans('importm.createuser')}}</option>
                        <option value="2">{{trans('importe.createuser')}}</option>
                        </select>
                       ...
                       <div class="row">
                        ...
                        <div class="row">
                          ...
                          <input type="submit" value="{{trans('buttonsave.productimport')}}" class="save btn btn-primary">
                           <input type="button" value="{{trans('buttonsave.save_print')}}" class="savep btn btn-primary">
...
var myCallBack = function() {  $( "#frm_create_user" ).submit(); $("#printdata").show();   }; 
