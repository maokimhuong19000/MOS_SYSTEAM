...
@section('content')	
{{ Breadcrumbs::render('report_port') }}
<div class="row">
...
<div class="card-icon">
      ...
      <h4 class="card-title">{{trans('report_isubstance.port_title')}}</h4>
</div>
...
<div class="card-body table-responsive">
       <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 ">
          <div class=" row" id= "d1">
              ...
              <div class="col-md-6" >
                  <div class="form-group bmd-form-group">
                   <label class="bmd-label-static">{{trans('back.placei_isubstance')}}</label>
    ...
    var querystring =  "?year="+yearr ;
      ...
      jqxhr = $.ajax({ url: '{!! route('report.isubtancebycompany.column')!!}'+querystring ,  
              ...
              .done(function (data) {
                ...
                $(tableName).empty();
                   var jsoncolumn = {};
                    jsoncolumn["data"] = 'port_name';
                    jsoncolumn["name"] = 'port_name';   
                ...
                tbl = $(tableName).dataTable({
                     proccessing:true,
                      ...
                      ajax:'{!! route('report.getIsubstanceByPort.year')!!}?year='+yearr,
                      "columns" : colss,
      ...
      jqxhr = $.ajax({ url: '{!! route('report.isubtancebycompany.column')!!}'+querystring ,
              ...
              tbl =  $(tableName).dataTable({
                     ...
                     scrollX : true,
                      ...
                      ajax:'{!! route('report.getIsubstanceByPort.filter')!!}?from='+froms+'&to='+tos,
                      "columns" : colss,
...
$("#searchsub").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getIsubstanceByPort.year')!!}?year='+yearr);
...
$("#searchf").click(function(){
  $.LoadingOverlay("show");
   ...
   total_year.api().ajax.url('{!! route('report.getIsubstanceByPort.filter')!!}?from='+froms+'&to='+tos);
   total_year.api().column(0).search( opt ).draw();
  $.LoadingOverlay("hide");
});
