...
@section('content')
{{ Breadcrumbs::render('equipmentrequest') }}
       ...
       <div class="col-lg-12 col-md-12">
              <div class="card">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h4 class="card-title">{{trans('ad_equipment.title')}}</h4>
                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
      $('#ManageTable').DataTable({
        ...
        serverSide:true,
        responsive: true,
        ajax:'{!! route('equipmentrequest.get_datatables')!!}',
        columns:[
          ...
          { "sortable": false, "className": "text-right",
              "render": function ( data, type, full, meta ) { 
                  var show = '<span data-original-title="" title=""><a href="'+
                    '{!! route('equipmentrequest.showdetail','@id') !!}' + '"><i class="material-icons">visibility</i><div class="ripple-container"></div></a></span>' ;
