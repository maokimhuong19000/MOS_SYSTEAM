                    ...
                    <table cellspacing="0">
                        <tr>
                            <td>
                                <table class="soapbox">
                                    <tr>
                                        <td class="soapbox-title" style="font-family: Battambang,Arial,Helvetica,sans-serif">{{trans('front.request_quota')}} </td>
                                    </tr>
                                </table>
                                ...
                                <table class="body">
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <table class="body-text">
                                                <tr>
                                                    <th class="" width="40%">{!!trans('label_iquota.substance')!!}</th>
                                                    <th class="" width="30%">{!!trans('label_iquota.quanlity')!!}</th>
                                                    <th class="" width="30%">{!!trans('label_iquota.old_quanlity')!!}</th>
                                                ...
                                                <tr>
                                                    <td class="body-signature-cell">
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="{{route('annualquotarequest.companyquota',$requestdetail->id)}}"
