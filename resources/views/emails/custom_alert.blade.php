                    ...
                    <table cellspacing="0">
                        <tr>
                            <td>
                                <table class="soapbox">
                                    <tr>
                                        <td class="soapbox-title" style="font-family: Battambang,Arial,Helvetica,sans-serif">ក្រុមហ៊ុនបានភ្ជាប់ ឯកសារ ប្រតិវេទន៍គយ/ Company Uploaded Custom Declaration File </td>
                                    </tr>
                                </table>
                                        ...
                                        <td class="">
                                            <table  class="body-text">
                                                <tr>
                                                    ...
                                                    <td align="" class="bodycopy  body-text-cell ">{{$requestdetail->customer->company_name}}</td>
                                                </tr>
                                                <tr>
                                                    <td class="bodycopy body-text-cell"  align="left"><b>{{trans('label_contact.com_code')}}:</b></td>
                                                    <td align="" class="bodycopy  body-text-cell">{{$requestdetail->customer->idcard}}</td>
                                                </tr>

                                                <tr>
                                                    <td class="bodycopy body-text-cell" align="left"><b>{{trans('label_contact.user_acc')}}:</b></td>
                                                    <td align="" class="bodycopy  body-text-cell">{{$requestdetail->customer->user_name}}</td>
                                                </tr>

                                                <tr>
                                                    <td class="bodycopy body-text-cell" align="left"><b>{{trans('label.email')}}:</b></td>
                                                    <td align="" class="bodycopy
                                                    body-text-cell">{{$requestdetail->customer->email}}</td>
                                                </tr>

                                                <tr>
                                                    <td class="bodycopy body-text-cell" align="left"><b>{{trans('adisubstance.requestno')}}:</b> </td>
                                                    <td align="" class="bodycopy  body-text-cell">{{$requestdetail->request_no}}</td>
                                                </tr>
                                                <tr>
                                            ...
                                            <h5>Company have just upload custom declaraion file . Help check to finalize the process.</h5>
                                                ...
                                                <tr>
                                                    <td class="body-signature-cell">
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="{{route('materialrequest.materialrequest_detail',$requestdetail->id)}}"
                                                               style="background-color:#41CC00;background-image:url(https://www.filepicker.io/api/file/N8GiNGsmT6mK6ORk00S7);border:1px solid #407429;border-radius:4px;color:#ffffff;display:inline-block;font-family:sans-serif;font-size:17px;font-weight:bold;line-height:38px;text-align:center;text-decoration:none;width:210px;-webkit-text-size-adjust:none;mso-hide:all;">Go to Detail </a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
