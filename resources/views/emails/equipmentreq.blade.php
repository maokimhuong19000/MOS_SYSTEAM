            ...
            <table cellspacing="0">
              <tr>
                <td>
                  <table class="soapbox">
                    <tr>
                      <td class="soapbox-title" style="font-family: Battambang,Arial,Helvetica,sans-serif">{{trans('head.fro_iequipment')}}</td>
                    </tr>
                  </table>
                         ...
                         <table  class="body-text">
                           <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                  <td class="bodycopy body-text-cell" align="left"><b>{{trans('back.request_date')}}: </b></td>
                          ...
                          <table class="body-text">
                              <tr>
                                  <th class="" width="40%">{{trans('ad_equipment.description')}}</th>
                                  <th class="" width="30%">{{ trans('inputco.productimport') }}</th>
                                  <th class="" width="30%">{{trans('ad_equipment.amount')}}</th>
                              ...
                              @foreach($requestdetail->Equipmentrequestdetail as $rd)
                                  <tr>
                                      <td style="padding-top:5px;">
                                          {{$rd->description}}
                                      </td>
                                      <td style="padding-top:5px;">
                                          {{$rd->Equipment->taxcode}}
                                      </td>
                                      <td style="padding-top:5px;" >
                                          {{$rd->amount}}
                                      </td>
