                    ...
                    <tr>
                      ...
                      <td class="">
                         <table  class="body-text">
                           <tr>
                            ...
                            <tr>
                             ...
                             <tr>
                                  <td class="bodycopy body-text-cell" align="left"><b>{{trans('front_contact.contact_name')}}:</b></td>
                        ...
                        <table class="body-text">                             
                                ...
                                @foreach($request->Equipmentrequestdetail as $rd)
                                <tr>
                                  ...
                                  <tr>
                                      <td class="body-signature-cell">
                                          ...
                                          <div>
                                              ...
                                              <a href="{{route('equipmentrequest.showdetail',$request->id)}}"
