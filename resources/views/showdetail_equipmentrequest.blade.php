@extends('layout.front') @section('content') @include('layout.partical.headuser') <div class="container">
    <div class="col-sm-12 col-xs-12 padding_bottom padding-top-lg-extra bg_child ">
        ...
        <div class="col-md-12 ">
            <div class="flash-message"> @foreach (['error', 'warning', 'success', 'info'] as $key) @if(Session::has($key)) <p class="alert alert-{{$key}} ">{{ Session::get($key) }}
            ...
            <div class="panel panel-moe">
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-12"> <span id="data_isubstance " class="content_bottom_font_sm">{{trans('idata.isubstance_status')}} : <span class="{{ \App\Helpers\AppHelper::instance()->import_status_classf($Equipmentrequest->import_status) }}"> {{ \App\Helpers\AppHelper::instance()->import_status($Equipmentrequest->import_status) }}</span></span></div>
                    <div class="col-sm-12 "> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="" name="" ] value="{{$Equipmentrequest->transport==1 ? 'SEA Transport' :'Road Transport' }}" disabled="true">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{trans('front_isubstance.file_shipping')}}</label><br> @foreach($Equipmentrequest->Eladings as $ind => $file) <a href="{{asset($file->file_path)}}" target="_blank"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></a><br /> @endforeach
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>{{trans('front_isubstance.File_customer_declar')}}</label><br> @foreach($Equipmentrequest->Epackinglists as $ind => $file) <a href="{{asset($file->file_path)}}" target="_blank"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></a><br /> @endforeach
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12 "> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
                    ...
                    <div class="col-sm-12 ">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <span class="smtext">
                                    <input type="text" class="billdate form-control" name="billdate" value="{{$Equipmentrequest->billdate}}" disabled="disabled"></span>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{trans('front_isubstance.File_Invioce')}}</label><br> @foreach($Equipmentrequest->Einvoices as $ind => $file) <a href="{{asset($file->file_path)}}" target="_blank"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span></a><br /> @endforeach
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel-body">
                    <div id="" class="mtable">
                        <table id="ManageTable" class="table  table-bordered" style="width:100%">
                            ...
                            <tbody> @foreach($Equipmentrequest->Equipmentrequestdetail as $index => $equipment) <tr>
                                    <td>{{($index+1)}}</td>
                    ...
                    <div class="form-group">
                    </div> @if ($Equipmentrequest->import_status >= 2 ) <div class="form-group">
                        <span>{{trans('front_isubstance.file_department')}}</span>
                    </div> @endif <div class="col-sm-6 "></div>
                    <div class="col-sm-6 ">
                        <div class="text-right">
                            <a href="{{route('front.idata')}}" class="btn btn-primary btn-lg">Back</a> @if($Equipmentrequest->import_status < 2) <a href="{{route('front.update_equipment',$Equipmentrequest->id)}}" class="btn btn-success btn-lg">កែប្រែ/Edit</a> @endif
                        </div>
                    </div>
                </div>
            </div>
