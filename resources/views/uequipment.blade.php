...
<form action="{{route('equipment.update',$Equipmentrequest->id)}}" method="POST" enctype="multipart/form-data">
    {{ csrf_field() }}
    {{method_field('PUT')}}
    @foreach($Equipmentrequest->Eladings as $index => $file)
    <div id="hide_shipp">

    </div>
    @endforeach
    @foreach($Equipmentrequest->Epackinglists as $index => $file)
    <div id="hide_cus">

    </div>
    @endforeach
    @foreach($Equipmentrequest->Einvoices as $index => $file)
    <div id="hide_inv">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="country_id" class="form-control">
                                        ...
                                        <option value="{{$country->id}}" {{$Equipmentrequest->country_id== $country->id?  "selected":""}}>{{$country->countries_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="manufacture_country_id" class="form-control">
                                        @foreach($countries as $country)
                                        <option value="{{$country->id}}" {{ $Equipmentrequest->manufacture_country_id == $country->id ? "selected":"" }}>{{$country->countries_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="col-md-6">
                                <div class="form-group " id="dfs_1">
                                    ...
                                    <span class="star_require text-danger">*</span>
                                    <input type="hidden" class="form-control ship" id="fs_1">
                                    @foreach($Equipmentrequest->Eladings as $index => $file)
                                    <div class="col-sm-12 no-padding form-group" id="dfs_{{$index+2}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="dfc_1">
                                    ...
                                    <span class="star_require text-danger">*</span>
                                    <input type="hidden" class="form-control custom" id="fc_1">
                                    @foreach($Equipmentrequest->Epackinglists as $index => $file)
                                    <div class="col-sm-12 no-padding form-group" id="dfc_{{$index+2}}">
                                        <div class="col-xs-10 no-padding">
